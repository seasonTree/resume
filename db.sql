...
(
	...
	company_type varchar(30) not null default '' comment '公司类型，大展/同和',
...
INSERT INTO resume.rs_permission (id, parent_id, p_name, p_type, p_icon, url, p_act_name, p_component, api, idx, ct_user, ct_time, mfy_user, mfy_time) VALUES (46, 40, '招聘负责人统计', 1, '', '', 'report_person_recru_list', '', '/api/report/person_recru/recruitment_list', 48, 'admin', '2018-12-27 11:31:52', 'admin', '2018-12-27 15:31:23');
INSERT INTO resume.rs_permission (id, parent_id, p_name, p_type, p_icon, url, p_act_name, p_component, api, idx, ct_user, ct_time, mfy_user, mfy_time) VALUES (47, 40, '候选人跟踪表', 1, '', '', 'report_person_recru_candidate', '', '/api/report/person_recru/candidate_list', 49, 'admin', '2018-12-27 11:35:44', 'admin', '2018-12-27 15:31:23');
INSERT INTO resume.rs_permission (id, parent_id, p_name, p_type, p_icon, url, p_act_name, p_component, api, idx, ct_user, ct_time, mfy_user, mfy_time) VALUES (48, 40, '数据导出excel', 1, '', '', 'report_person_recru_export_excel', '', '/api/person_recru/export', 50, 'admin', '2018-12-27 11:37:47', 'admin', '2018-12-27 15:31:23');
