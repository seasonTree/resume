  ...
  <div>
    <el-row class="table-container resume">
      ...
      <div class="search" ref="search">
        ...
        >
          <div v-show="showOtherSearch" class="other-search-detail">
            <el-row :gutter="20">
              <el-col :span="4">
                <el-input-number
                  placeholder="最低薪资"
        ...
        <el-row :gutter="20">
          <div class="other-search-container">
            <a
              ...
              class="other-search"
            >
              <i class="fa fa-angle-double-down" :class="{ 'up-icon' : showOtherSearch}"></i>
              搜索条件
            </a>
          </div>
        </el-row>
      ...
      >
        ...
        <el-table-column fixed prop="sex" label="性别" width="50"></el-table-column>
        <el-table-column fixed prop="age" label="年龄" width="50"></el-table-column>
        <el-table-column fixed prop="expected_job" label="岗位" width="80">
          <template slot-scope="scope">
            <el-tooltip effect="dark" :content="scope.row.expected_job" placement="top">
              <div class="cell">{{scope.row.expected_job}}</div>
            </el-tooltip>
          </template>
        </el-table-column>
        <el-table-column fixed prop="phone" label="手机" width="150"></el-table-column>
        <el-table-column fixed prop="educational" label="学历" width="100"></el-table-column>
        <el-table-column fixed prop="work_year" label="工作年限" width="120"></el-table-column>
        <el-table-column prop="email" label="电子邮箱" width="200"></el-table-column>
        <el-table-column prop="expected_money" label="期望薪资" width="150"></el-table-column>
        <!-- <el-table-column
                    prop="inPosition"
                    label="所处职位"
                    width="120"
        ...
        <el-table-column prop="nearest_unit" label="最近单位" width="220"></el-table-column>
        <el-table-column prop="nearest_job" label="最近职位" width="120"></el-table-column>
        <el-table-column prop="school" label="毕业院校" width="300"></el-table-column>
        <el-table-column prop="speciality" label="专业" width="150"></el-table-column>

        <el-table-column prop="english" label="英语等级" width="120"></el-table-column>
        <el-table-column prop="expected_address" label="期望工作地" width="200"></el-table-column>
        <el-table-column fixed="right" label="操作" width="180">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="添加附件" placement="top">
              <el-button
                type="info"
                size="mini"
            ...
            <el-tooltip effect="dark" content="沟通管理" placement="bottom">
              <el-button
                type="success"
                size="mini"
    ...
    <view-resume :show.sync="viewDialog" :id="viewID"></view-resume>

    <communication :show.sync="communicationDialog" :resume_id="communicationID"></communication>

    <upload-file :show.sync="uploadFileDialog" :resume_id="uploadFileID"></upload-file>

    <importExcel :show.sync="ImportExcelDialog" @refresh-data="getData"></importExcel>
  </div>
</template>
