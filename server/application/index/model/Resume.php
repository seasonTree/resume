...
class Resume extends Model
{
    ...
    public function getId($where = '1=1'){
        //获取id集合
        return Resume::field('id')->where($where)->select()->toArray();
    }
    ...
    public function getCandidate($where = '1=1'){
        ...
        return Resume::where($where)
                     ->field('id,name,phone,email,school,educational,graduation_time,work_year,source,ct_user,ct_time,company_type')
                     ->select()
                     ->toArray();
    }
