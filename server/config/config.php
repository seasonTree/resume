...
return [
    ...
    'group_title' => "/^(基本资料|自我评价|自我描述|自我介绍|目前状况|工作经历|工作业绩|工作经验|教育经历|教育背景|项目经验|项目经历|项目实施经验|简历内容|技能特长|技能专长|专业技能|技术专长|求职意向|作品展示|证书|获奖证书|语言能力|培训经历|附加信息|在校情况)/",
    //标题分组后匹配
    ...
    //教育经历匹配集合
        ...
        'school' => "/[^至今：:\d-]([\x{4e00}-\x{9fa5}]+)(大学|学院|学校)/u",
        'speciality' => "/($speciality)/u",
        'educational' => "/(初中|高中|大专|统招大专|自考大专|民办大专|本科|统招本科|自考本科|民办本科|硕士|博士|研究生|无学历|全日制统招)/",
