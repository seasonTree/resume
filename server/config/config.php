...
return [
    ...
    'basicData' => [
        ...
        'expected_money' => "/(期望薪水|期望薪资|期望月薪)(:|：)?(\d+\-\d+|\d+(万以上|\/月|\/年|\/月以上|\/年以上|元\/月|元\/年)?)/",
        'expected_industry'  =>  "/(期望从事行业|希望行业|期望行业|意向行业)(:|：)?(.*)?/u",
        'expected_address'  =>  "/(目标地点|期望地点|地点|工作地点|意向地区)(:|：)(.*)?/",
    ...
    'educationalBackground' => [
        ...
        'educational' => "/(初中|高中|大专|本科|硕士|博士|研究生)/",
        'speciality' => "/($speciality)/u",
        'graduation_time' => "/(\d{4}\/\d{1,2}(至|--|-)(\d{4}\/\d{1,2}|至今))|(\d{4}年毕业)|(\d{4}年\d{1,2}月毕业)/",
    ],
    ...
    'projectExperience' => [
        'project_rule' => "/([\x{4e00}-\x{9fa5}]+(\d{4}(\/|\.|-)\d{1,2}(至|--|-|－)(\d{4}(\/|\.|-|－)\d{1,2}|至今)))|((\d{4}(\/|\.|-|－)\d{1,2}(至|--|-|－)(\d{4}(\/|\.|-|－)\d{1,2}|至今))(:|：)?[\x{4e00}-\x{9fa5}]+)/u",
        'project_time' => "/\d{4}(\/|\.|-|－)\d{1,2}(至|--|-|－)(\d{4}(\/|\.|-|－)\d{1,2}|至今)/",
        // 'project_name' => "/(\d{4}(\/|\.|-)\d{1,2}(至|--|-)(\d{4}(\/|\.|-)\d{1,2}|至今)(.*))/u",
        'envy_responsibility' => "/(责任描述|项目责任|项目职责|1,|1\.|1、)(.*)/",
        // 'content' => "/(.*)(项目描述|1\,|1\.|1、)(.*)/",
        'content' => "/(项目描述|1,|1\.|1、)(.*)/",
    ],
