...
return [
    ...
    'group_title' => "/^(基本资料|自我评价|自我描述|自我介绍|目前状况|工作经历|工作业绩|工作经验|教育经历|教育背景|项目经验|项目经历|简历内容|技能特长|技能专长|专业技能|求职意向|作品展示)/",
    //标题分组后匹配
    ...
    'base_replace_blank' => "/(基本资料|ID:\d+|招聘网|智联招聘|前程无忧|匹配度(:|：)\d{2}%)|个人简历|(j\d+)/i",
    ...
    //基本资料的匹配规则集合
        ...
        'english' => "/(英语水平|英语)(:|：)?(专业|大学)(4|四|6|六|八|8|tem4|tem8|cet4|cet6|cet8)(级)?/i"
    ],
    ...
    //工作经历匹配集合
        ...
        'company_name' => "/(中关村|公司|集团|超市|科技|酒店|$city|局|学校|网络|通|伟业|厂)/u",
