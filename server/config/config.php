...
return [
    ...
    'workExperience' => [
        ...
        'company_name' => "/(中关村|公司|集团|超市|科技|酒店|$city|局|学校|网络|通|伟业)/u",
        'company' => "/(($city)(.*)(公司|集团|超市|科技|酒店|局|学校|网络|通|伟业)?((\(|（|\[)(\d+年\d+个月|\d+年|\d+个月)?(\)|）|\]))?)|(($city)?(.*)(公司|集团|超市|科技|酒店|在线|局|学校|通|伟业)((\(|（|\[)(\d+年\d+个月|\d+年|\d+个月)?(\)|）|\]))?)/u",
        'job' => "/($job)/u",
